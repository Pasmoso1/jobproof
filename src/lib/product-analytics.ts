...
export const PRODUCT_ANALYTICS_EVENTS = {
  ...
  subscription_checkout_tax_enabled: "subscription_checkout_tax_enabled",
  subscription_checkout_address_missing: "subscription_checkout_address_missing",
  stripe_customer_address_synced: "stripe_customer_address_synced",
  stripe_customer_address_sync_failed: "stripe_customer_address_sync_failed",
  subscription_tax_configuration_error: "subscription_tax_configuration_error",
  partner_application_submitted: "partner_application_submitted",
  partner_application_approved: "partner_application_approved",
  partner_application_declined: "partner_application_declined",
  partner_referral_signup: "partner_referral_signup",
  partner_trial_started: "partner_trial_started",
  partner_subscription_started: "partner_subscription_started",
  partner_reward_qualified: "partner_reward_qualified",
  partner_reward_paid: "partner_reward_paid",
  ...
  founding_partner_approved: "founding_partner_approved",
  standard_partner_approved: "standard_partner_approved",
  ...
  quote_question_submitted: "quote_question_submitted",
  quote_change_request_submitted: "quote_change_request_submitted",
} as const;
