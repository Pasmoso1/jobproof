    ...
    return (
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            {busy === "essential"
              ...
              : showManagedTrialSubscribe
                ? soloPrimary
                  ? "Subscribe to Solo — $39 CAD/mo + applicable taxes"
                  : "Switch to Solo — $39 CAD/mo + applicable taxes"
                : "Choose Solo — $39 CAD/mo + applicable taxes"}
          </button>
          <button
            type="button"
          ...
          >
            {busy === "professional"
              ...
              : showManagedTrialSubscribe
                ? !soloPrimary
                  ? "Subscribe to Pro — $59 CAD/mo + applicable taxes"
                  : "Switch to Pro — $59 CAD/mo + applicable taxes"
                : "Choose Pro — $59 CAD/mo + applicable taxes"}
          </button>
        </div>
        <div>
          <button
        ...
        <p className="text-xs text-zinc-500">
          Solo — $39 CAD/month + applicable taxes · Pro — $59 CAD/month + applicable taxes
        </p>
      </div>
    );
  }
